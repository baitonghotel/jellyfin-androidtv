...
android {
	...
	buildTypes {
		release {
			...
			resValue("string", "app_id", "tv.baitong.app")
			resValue("string", "app_search_suggest_authority", "tv.baitong.app.content")
		...
		debug {
			...
			// Set package names used in various XML files
			resValue("string", "app_id", "tv.baitong.app" + applicationIdSuffix)
			resValue("string", "app_search_suggest_authority", "tv.baitong.app${applicationIdSuffix}.content")
